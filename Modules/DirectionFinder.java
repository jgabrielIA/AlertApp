...
public class DirectionFinder {
    ...
    private static final String GOOGLE_API_KEY = "AIzaSyBdEAmcu-MJTt7c_lNMynxZ7MCYSnf6AZI";
    ...
    private void parseJSon(String data) throws JSONException {
        ...
        for (int i = 0; i < jsonRoutes.length(); i++) {
            ...
            routes.add(route);  // despues de decodificar puntos los añade a la lista
        }

        listener.onDirectionFinderSuccess(routes);  // activa escucha
    }
